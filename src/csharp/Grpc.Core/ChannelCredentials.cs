...
namespace Grpc.Core
{
    ...
    public sealed class SslCredentials : ChannelCredentials
    {
        ...
        /// <summary>
        /// Destructor used to ensure that the managed code calls the destroy
        /// callback (aggregated into `VerifyPeerCallbackHandler`) before this
        /// object gets garbage collected and prevent NullPointerException when
        /// runing with Mono.
        /// </summary>
        ~SslCredentials()
        {
